...
public class KCharInputEngine: MonoBehaviour
{
    public MoveControllerKinematic mControl;
    ...
    //MOVEMENT
    void GetMoveValue() //Gets the "move" for movement (either 1 or -1) and sets the blocking state
    {
